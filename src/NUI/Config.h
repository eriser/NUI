...
#define NUI_ICON_HELP NUI_MAKE_ICON(1, 29)

// Directional/arrow icons
#define NUI_ICON_UP NUI_MAKE_ICON(7, 29)
#define NUI_ICON_DOWN NUI_MAKE_ICON(5, 29)
#define NUI_ICON_LEFT NUI_MAKE_ICON(6, 29)
#define NUI_ICON_RIGHT NUI_MAKE_ICON(4, 29)
